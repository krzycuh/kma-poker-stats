      ...
      {displayedPlayers && displayedPlayers.length > 0 && (
        <div className="flex flex-col gap-1.5 sm:gap-2">
          {displayedPlayers.map((player) => (
            <div
              key={player.id}
              className={`flex items-center gap-2 sm:gap-3 rounded-lg border px-2.5 sm:px-4 py-2 sm:py-2.5 transition-shadow hover:shadow-sm ${
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                {player.userId ? (
                  <p className="truncate text-xs text-gray-500" title={player.userEmail || player.userId}>
                    {player.userEmail || player.userId}
                  </p>
                ) : (
